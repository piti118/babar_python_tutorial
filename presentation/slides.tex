...
\begin{itemize}
	\item Setup Session. 1.5 hour.\\ Monday Jan 28 2013 16:00-17:30 Redwood C/D.
...
\begin{itemize}
	\item Basic Python
	\item Reading ROOT File and Plotting
...
\end{block}
\begin{block}{Prepare your laptop in advance}
Visit our website for instruction. \url{http://piti118.github.com/babar_python_tutorial/}

\end{block}

}
\begin{frame}[c]
		\centerline{\Large Backup}
\end{frame}
