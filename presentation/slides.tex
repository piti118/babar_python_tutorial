...
\frame{
	...
	\end{block}
	\begin{block}{}
	There were a lot of missing pieces here and there when we began. We looked at what we need and implemented those missing pieces. We think we got most of them.	
	\end{block}
}
...
\begin{frame}[fragile, shrink=5]{Plotting Syntax}
	\begin{itemize}
...
\begin{frame}[fragile, shrink=5]{Multivariate Analysis and Fitting}
	...
	yourself.
		...
		\end{minted}
	\item Minuit and Likelihood/Chi2 construction
		\begin{itemize}
